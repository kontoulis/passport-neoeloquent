...
class TransientTokenControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $cookieFactory = Mockery::mock('NeoEloquent\Passport\ApiTokenCookieFactory');
        ...
        $controller = new NeoEloquent\Passport\Http\Controllers\TransientTokenController($cookieFactory);
